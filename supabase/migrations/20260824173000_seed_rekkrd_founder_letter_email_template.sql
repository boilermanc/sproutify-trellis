-- Rekkrd's reusable editorial/founder email layout.
-- Keep the HTML in sync with docs/email-templates/rekkrd-founder-letter.html.
...
SELECT
  '8d8ff75e-f0e5-4b8a-9852-c8fdaf3c3759'::uuid,
  b.id,
  'Rekkrd Founder Letter',
  'Reusable dark editorial note with a product announcement callout and CTA.',
  $rekkrd_html$<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
    ...
    <tr>
      <td class="outer-gutter" align="center" style="padding:32px 16px;">
        <table class="email-shell" role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:100%; max-width:600px; background-color:#14100c;">
          ...
          <tr>
            <td align="center" style="padding:24px 24px 32px; font-family:'Courier New', Courier, monospace; font-size:11px; line-height:18px; letter-spacing:0.5px; color:#6f675b;">
              Rekkrd &middot; <a href="https://rekkrd.com" style="color:#a89f92; text-decoration:none;">rekkrd.com</a><br>
              You're receiving this because you have a Rekkrd account.
              <a href="{{unsubscribe_url}}" style="color:#a89f92;">Unsubscribe</a>
            </td>
          </tr>
        </table>
      </td>
