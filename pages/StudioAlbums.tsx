...
const EMPTY_IDENTITY: StudioReleaseIdentity = { release_subtitle: '', series_name: '', subgenre: '', short_description: '', credits: '', ai_disclosure: 'This release includes AI-assisted music production.', copyright_note: '', catalog_number: '' };
...
const StudioAlbums: React.FC<Props> = ({ addToast }) => {
  ...
  useEffect(() => { if (selected) setIdentity({ release_subtitle: selected.release_subtitle || '', series_name: selected.series_name || '', subgenre: selected.subgenre || '', short_description: selected.short_description || '', credits: selected.credits || '', ai_disclosure: selected.ai_disclosure || EMPTY_IDENTITY.ai_disclosure, copyright_note: selected.copyright_note || '', catalog_number: selected.catalog_number || '' }); }, [selected?.id]);
