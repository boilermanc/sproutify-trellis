...
const ContextAwareHelp: React.FC<ContextHelpProps> = ({ activeView, onOpenArticle, onOpenHelpCenter }) => {
  ...
  return (
    <div className="fixed bottom-32 right-8 z-[80] flex flex-col items-end pointer-events-none">
      ...
      {/* Popover */}
      {isOpen && (
        <div className="mb-6 w-80 bg-white shadow-xl border border-slate-200 overflow-hidden animate-in slide-in-from-bottom-4 duration-300 pointer-events-auto">
          ...
          <div className="p-5 bg-slate-900 text-white flex justify-between items-center">
            <div className="flex items-center space-x-3">
              ...
              <h4 className="font-mono text-[11px] font-bold tracking-wide">{helpContext.title} help</h4>
            </div>
          ...
          <div className="p-4 space-y-2">
            {helpContext.items.map((item, i) => (
              ...
              >
                <div className="p-3.5 bg-slate-50 hover:bg-emerald-50 border border-slate-200 hover:border-emerald-300 flex items-start justify-between group transition-colors">
          ...
          <div className="px-4 pb-4">
            <button
              ...
              className="w-full min-h-11 py-2.5 text-sm font-bold text-slate-500 hover:text-emerald-700 transition border border-slate-200 hover:border-emerald-300 hover:bg-emerald-50"
            >
              Open Help Center
            </button>
          </div>
      ...
      <button
        ...
        className={`pointer-events-auto w-12 h-12 flex items-center justify-center shadow-lg transition-colors duration-300 relative border ${
          isOpen
      ...
      >
        ...
        {!isOpen && hasNewTip && (
          <div className="absolute -top-10 right-0 bg-emerald-600 text-white px-3 py-1.5 font-mono text-[10px] font-bold tracking-wide shadow-lg animate-in slide-in-from-bottom-2 duration-300 whitespace-nowrap">
