...
import {
  ...
  ChevronDown, Plug, Wand2, Palette, Video, Menu, X, Music, Clapperboard, Film, Send, MessageCircle, Sparkles, TrendingUp, CalendarClock, LayoutTemplate, Award, UserPlus, BrainCircuit, SearchCheck
} from 'lucide-react';
