...
test('Media Generation gives first-time operators an in-product walkthrough', async () => {
  ...
  assert.match(page, /workspaceView === 'create' && <details[\s\S]*?<MediaGenerationGuide/);
  assert.match(page, /selectedProjectId && <main/);
  assert.match(page, /project.branch_id === newProjectBranch/);
